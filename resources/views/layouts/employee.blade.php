                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link @if ($active == 'Dashboard') active @endif "
                                    href="{{ url('employee/dashboard') }}" data-target="#submenu-1"
                            ...
                            <li class="nav-item ">
                                <a class="nav-link @if ($active == 'jobs') active @endif "
                                    href="{{ url('employee/jobs/index') }}" data-target="#submenu-1"
                                    aria-controls="submenu-1"><i class="fas fa-fw fa-chart-pie"></i> Jobs  </a>
                            </li>
                        </ul>
                    </div>
                </nav>
