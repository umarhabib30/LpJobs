                    ...
                    <form method="post" action="{{ url('admin/business/store') }}" id="add_business_form">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input id="business_name" type="text" class="form-control" required name="business_name" value="{{old('business_name')}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="address" class="col-form-label">Door No</label>
                                <input id="address" type="text" class="form-control" required name="address" value="{{old('address')}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="road" class="col-form-label">Road</label>
                                <input id="road" type="text" class="form-control" required name="road" value="{{old('road')}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="town" class="col-form-label">Town</label>
                                <input id="town" type="text" class="form-control" required name="town" value="{{old('town')}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="city" class="col-form-label">City</label>
                                <input id="city" type="text" class="form-control" required name="city" value="{{old('city')}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="post_code" class="col-form-label">Postal Code</label>
                                <input id="post_code" type="text" class="form-control" required name="post_code" value="{{old('post_code')}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="tel" class="col-form-label">Telephone</label>
                                <input id="tel" type="text" class="form-control" required name="tel" value="{{old('tel')}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="mobile" class="col-form-label">Mobile</label>
                                <input id="mobile" type="text" class="form-control" required name="mobile" value="{{old('mobile')}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="email" class="col-form-label">Email</label>
                                <input id="email" type="text" class="form-control" required name="email" value="{{old('email')}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="web" class="col-form-label">Website</label>
                                <input id="web" type="text" class="form-control" required name="web" value="{{old('web')}}">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Notes</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" required name="notes"></textarea>
                        </div>
