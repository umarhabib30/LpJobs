                    ...
                    <form method="post" action="{{ url('admin/job/update') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="input-select" name="customer_id" disabled>
                                    @foreach ($businesses as $business)
                                        <option value="{{ $business->id }}"
                                            @if ($business->id == $job->customer_id) selected @endif>{{ $business->business_name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="" class="form-control "
                                    value="{{ $job->orderTakenBy->name }}" readonly>
                            </div>
                                ...
                                <select class="form-control" id="input-select" name="item_id">
                                    ...
                                    @foreach ($items as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id == $job->item_id) selected @endif>{{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="form-control select_user" id="input-select" name="assigned_to_id">
                                    ...
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}"
                                            @if ($user->id == $job->assigned_to_id) selected @endif>{{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <select class="form-control" id="input-select" name="size_id">
                                    ...
                                    @foreach ($sizes as $size)
                                        <option value="{{ $size->id }}"
                                            @if ($size->id == $job->size_id) selected @endif>{{ $size->size }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="input-select" name="quantity">
                                    ...
                                    @for ($i = 1; $i <= 10; $i++)
                                        <option value="{{ $i }}"
                                            @if ($i == $job->quantity) selected @endif>{{ $i }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
