...
<body>
    ...
    <div class="container">
        <table  style="width: 100%">
            <tr>
                <td style="width: 70%;"><strong>Invoice to:</strong> {{$invoice_to}}</td>
        ...
        <table class="table">
            ...
            <tr style="min-height: 280px;">
                <td style="min-height: 280px;">{{$quantity}}</td>
                <td style="width: 60%; min-height: 280px;">{{$description}}</td>
                <td style="min-height: 280px;"></td>
                <td style="min-height: 280px;">{{$item}}</td>
            </tr>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="col text-center">
            <strong>
                ...
                Bank details: <span style="color: red;">Account Name: Liquid Print, Sort Code: 09-02-22, Account No.:
                    10696839</span><br>
